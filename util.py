...
def save_adversarial_data(x_train, y_train, y_wrong_train, x_test, y_test, y_wrong_test, dataset, attack_type, root_path='data'):
    ...
    train_path = root_path+sep+'training_set'+sep+threat_type+sep+dataset+sep+attack_type+sep
    train_images = train_path+'train-images-npy.gz'
    train_labels = train_path+'train-labels-npy.gz'
    wrong_train_labels = train_path+'wrong-train-labels-npy.gz'
    
    test_path = root_path+sep+'benchmark_dataset'+sep+threat_type+sep+dataset+sep+attack_type+sep
    test_images = test_path+'test-images-npy.gz'
    test_labels = test_path+'test-labels-npy.gz'
...
def load_adv_data(dataset, variation_type, root_path='data'):
    ...
    fixed_path = root_path+sep+'training_set'+sep+transformation_type+sep+dataset+sep+variation_type+sep
    print('loading training  data from', fixed_path)
    ...
    fixed_path = root_path+sep+'benchmark_dataset'+sep+transformation_type+sep+dataset+sep+variation_type+sep
    print('loading test data from', fixed_path)
